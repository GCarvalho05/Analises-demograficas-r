...
* **Atv1_Interpolacao:** Aplicação de métodos numéricos de interpolação para estimativa de dados.
...
---
*Cada pasta contém o respectivo script e as conclusões geradas a partir das análises.*
